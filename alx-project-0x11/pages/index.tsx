  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100 p-4">
      <div className="flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-2">Image App</h1>
        <p className="text-lg text-gray-700 mb-4">
          Generate Stunning images based on your prompt
        </p>
      ...
      </div>
      {
        generatedImages.length ? (
          <div className="">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 border max-w-full md:max-w-[1100px] p-2 overflow-y-scroll h-96">
              {generatedImages?.map(
